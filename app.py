...
import io # Para ler a string CSV como um arquivo
...
# --- 2. Dados de Entrada (CSV Hardcoded) ---
# O seu código original continha os dados em uma string, vamos mantê-los aqui
...
IT005,Calça Jeans,Renner,38,2025-08-05,2025-09-01,25.00,90.00,Vendido
IT006,Sapato Scarpin,Schutz,36,2025-08-05,2025-08-20,35.00,110.00,Vendido
IT007,Jaqueta de Couro,Genérica,M,2025-08-10,,60.00,250.00,Disponível
IT008,Camiseta de Banda,C&A,P,2025-08-11,2025-08-14,10.00,55.00,Vendido
IT009,Calça Jeans,C&A,42,2025-08-12,,20.00,80.00,Disponível
IT010,Vestido de Festa,Genérica,P,2025-08-15,2025-09-10,20.00,95.00,Vendido
"""

@st.cache_data
def carregar_e_preparar_dados(data):
    """Carrega e limpa os dados brutos."""
    # Uso de io.StringIO para ler a string como se fosse um arquivo
...
# Exibição dos dados brutos no Streamlit (opcional)
with st.expander("Ver Dados Brutos"):
    st.dataframe(df_filtrado)

# --- 3. Funções de Análise (Adaptadas do seu código) ---
...
def perform_performance_matrix(df_input):
    ...
    # Gera o gráfico de Matriz
    fig, ax = plt.subplots(figsize=(12, 8))

    # Matriz de Dispersão (Bubble Chart)
    scatter = ax.scatter(
        df_desempenho['Giro_Medio_Dias'],
        df_desempenho['Pecas_Vendidas'],
        s=df_desempenho['Margem_Media_%'] * 10,  # Tamanho da bolha pela margem
    ...
    # Anotações de Quadrantes (simplificado)
